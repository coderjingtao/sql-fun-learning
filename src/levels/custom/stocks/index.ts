...
export default {
  ...
  answer:
    ...
    "    ROUND(AVG(CASE WHEN transaction_type = 'Buy' THEN 100.0 ELSE 0 END), 1) || '%' AS buy_ratio,\n" +
    "    ROUND(AVG(CASE WHEN investor_type = 'Institution' THEN 100.0 ELSE 0 END), 1) || '%' AS institution_ratio,\n" +
    ...
    "ORDER BY \n" +
    "    total_amount DESC;",
  hint: "Use subquery to find hot stock, calculate volatility using (max price - min price) / avg price",
  type: "custom",
  difficulty: 2,
} as LevelType;
